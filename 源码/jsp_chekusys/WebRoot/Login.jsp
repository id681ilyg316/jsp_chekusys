	...
	<div class="wrapLogin">
		    <div class="loginPanel">
		    	<form action="<%=path %>/LoginHandle" method="post">
		    		...
		    		<div class="logofont"><img width="100px" height="30px">地下停车场车库管理系统<hr></div>
		    		<br/><br/>
			       	<p><label>用名：</label><input type="text" name="user_id" value="" /></p>
			           	<p><label>密码：</label><input type="password" name="user_pwd" value=""  /></p>
			        	<p class="btn"><input type="submit" class="btnLogin" value="登陆"  /><input type="reset" class="btnCancel" value="重置" /></p>	       		
		       	</form>
		     </div>
    </div>
		<!-- loginPanel End -->
